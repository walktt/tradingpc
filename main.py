...
schedule.every(3).minutes.do(bybit_data.run_bybit_check, 'BTCUSD', 15, 75, 6)
# schedule.every(60).minutes.do(bybit_data.run_bybit_check, 'ETHUSD', 60, 240, 16)
schedule.every(3).minutes.do(tinkoff_data.run_tinkoff_check, ticker='RIU2', freq=ti.CandleInterval.CANDLE_INTERVAL_15_MIN, period_in_minutes=60, perc=6)
